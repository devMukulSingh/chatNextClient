...
const ImageModal: React.FC<ImageModal> = ({
    ...
    return (
        <>
            <Portal>
                <main id="image-modal" className='z-50 bg-slate-950 justify-center bg-opacity-50 flex flex-col fixed items-center w-screen h-screen'>
                    ...
                    <figure id="inner-modal" className='relative size-3/4'>
                        <Image src={imageUrl} fill alt="imageMessage" className='object-contain' />
                    </figure>
                </main>
            </Portal>
